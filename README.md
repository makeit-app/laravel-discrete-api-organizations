...
- POST   `api/user/organizations/members` - invite member(s) to the currently selected organization
- DELETE `api/user/organizations/members` - kick member(s) from the currently selected organization
